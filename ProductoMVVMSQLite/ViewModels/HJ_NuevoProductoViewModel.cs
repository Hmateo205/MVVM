...
namespace ProductoMVVMSQLite.ViewModels
{
    ...
    public class HJ_NuevoProductoViewModel
    {
        ...
        public HJ_NuevoProductoViewModel()
        {

        }


        public HJ_NuevoProductoViewModel(HJ_Producto producto)
        {
        ...
        public HJ_NuevoProductoViewModel(int IdProducto)
        {
